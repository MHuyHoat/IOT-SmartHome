                            ...
                            <div
                                ...
                                <div
                                    class="modal-dialog "
                                    role="document">
                                    <form class="modal-content" action="managerViTri.php?action=them-moi" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="col-12 mt-2">
                                                <label for="inputEmail" class="form-label">
                                                    ...
                                                    Tên vị trí </label>
                                                <input type="text" class="form-control" name="ten" placeholder="Nhập tên vị trí " required >
                                            </div>
                                            <div class="col-12 mt-2">
