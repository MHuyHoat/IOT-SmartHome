                ...
                <div class="card overflow-hidden radius-10">
                  <div class="profile-cover bg-dark position-relative mb-4">
                    <div class="user-profile-avatar shadow position-absolute top-50 start-0 translate-middle-x">
                      <img src="assets/images/avatars/0<?=$_SESSION['USER_ID']?>.png" alt="...">
                    </div>
                  </div>
                  <div class="card-body">
                    <div class="mt-5 d-flex align-items-start justify-content-between">
                      ...
                      <div class="">
                         <a href="javascript:;" class="btn btn-primary"><ion-icon name="send-sharp" role="img" class="md hydrated" aria-label="send sharp"></ion-icon>Send Message</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card radius-10">
                  <div class="card-body">
                    <h5 class="mb-3">Location</h5>
                     <p class="mb-0"><ion-icon name="compass-sharp" class="me-2 md hydrated" role="img" aria-label="compass sharp"></ion-icon>Kalkio Network</p>
                  </div>
                </div>
