          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0 align-items-center">
                ...
                <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa thông tin khu vực </li>
              </ol>
            </nav>
          </div>
        ...
        <div class="col-12 mt-2">
          ...
          <div class="col-12 mt-2">
            <label for="inputEmail" class="form-label">
              ...
              Tên khu vực </label>
            <input type="text" class="form-control" name="ten" value="<?= $detailKhuVuc['ten'] ?>" placeholder="Nhập tên khu vực" required>
          </div>
          <div class="col-12 mt-2">
