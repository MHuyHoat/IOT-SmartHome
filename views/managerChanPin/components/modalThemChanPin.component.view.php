<!-- Modal -->
<div class="modal fade" id="modalThemChanPin" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
    aria-hidden="true">
        ...
        <form class="modal-content" action="managerPin.php?action=them-moi" method="POST">
            ...
            <div class="modal-body">
                <div class="col-12 mt-2">
                    ...
                    <input type="text" name="id" class="form-control" id="inputPassword"
                        placeholder="ID thiết bị"></input>
                </div>
                <div class="col-12 mt-2">
                ...
                <div class="col-12 mt-2">
                    ...
                    <input type="text" name="mieu_ta" class="form-control" id="inputPassword"
                        placeholder="Miêu tả thiết bị">
                </div>
            </div>
